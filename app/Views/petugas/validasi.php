                        ...
                        <tbody>
                            ...
                            <?php foreach ($pengaduan as $p) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($p['status'] == "0") : ?> 
                                            <a class="btn btn-danger btn-sm" href="/petugas/tolak/<?= $p['id_pengaduan'] ?>"><i class="fa-solid fa-x"></i></a>
                                            <a class="btn btn-primary btn-sm" href="/petugas/updatevalidasi/<?= $p['id_pengaduan'] ?>"><i class="fa-solid fa-check"></i></a>
                                        <?php elseif ($p['status'] == "1") : ?>
                                            <a class="btn btn-primary btn-sm" href="/petugas/tanggapan/<?= $p['id_pengaduan'] ?>"><i class="fa-solid fa-message"></i></a>
                                        <?php elseif ($p['status'] == "2") : ?>
                                            <a class="btn btn-primary btn-sm" href="/petugas/detaillaporan/<?= $p['id_pengaduan'] ?>"><i class="fa-solid fa-circle-info"></i></a>
                                        <?php elseif ($p['status'] == "3") : ?>
                                            Ditolak
                                        <?php endif; ?>
                                    </td>
