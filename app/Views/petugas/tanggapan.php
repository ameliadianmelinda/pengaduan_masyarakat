            ...
            <div>
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <form action="/petugas/updatetanggapan/<?= $pengaduan['id_pengaduan']; ?>" method="post" enctype="multipart/form-data">
                                    <div class="mb-1">
                                    ...
                                    <button type="submit" class="me-1 btn btn-primary mt-4">Kirim</button>
                                </form>
                            </div>
                        </div>
                    </div>
